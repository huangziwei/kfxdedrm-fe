...
return {
    ...
    -- KOReader reads nothing from this field. It is here so the menu's
    -- `What's installed and where` can name the build a bug came from, and
    -- `build.sh` writes it from [workspace.package] in Cargo.toml -- do not
    -- edit it here.
    version = "0.5.0+dev",
